...
public class UserService {
    ...
    public JwtAuthenticationResponse authenticateUser(LoginRequest loginRequest){
        //The AuthenticationManager handles the authentication process.
        //A UsernamePasswordAuthenticationToken is created with the username and password from the loginRequest.
        Authentication authentication = authenticationManager.authenticate(
                new UsernamePasswordAuthenticationToken(loginRequest.getUsername(), loginRequest.getPassword()));

        // Sets the authentication in the SecurityContextHolder
        SecurityContextHolder.getContext().setAuthentication(authentication);
        // to get the userDetails from the authentication.
